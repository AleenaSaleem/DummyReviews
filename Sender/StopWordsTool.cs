...
namespace Sender
{
    public class StopWordsTool
    {
        ...
        #endregion
        public IEnumerable<IEnumerable<string>> RemoveStopWords(IEnumerable<IEnumerable<string>> data)
        {
            ...
            foreach(var row in dataList)
            {
                ...
                for(int j = 0; j < row.Count; j++)
                {
                    ...
                    row[j] = RemoveStopWordsFromSingleString(row[j].ToLower());
                }
        ...
        public static string RemoveStopWordsFromSingleString(string cellValue)
        {
            ...
            return string.Join(" ", splitCellList);
        }
